...
public class Waypoints_4WPS : MonoBehaviour {

    public bool firstWPs;
    public bool secondWPS;
    public bool thirdWPs;
    public bool fouthWPs;
    ...
    void Update()
    {
        ...
        if (fouthWPs)
        {
            distance = Vector3.Distance(gameObject.transform.position, patrolPoints4[currentPoint4].position);
            if (currentPoint4 < patrolPoints4.Length)
                if (transform.position == patrolPoints4[currentPoint4].position)
                {
                    currentPoint4++;
                }
            ...
            if (currentPoint4 == patrolPoints4.Length)
            {
                currentPoint4 = lastWP3;
                fouthWPs = false;
            }
            transform.position = Vector3.MoveTowards(transform.position, patrolPoints4[currentPoint4].position, moveSpeed * Time.deltaTime);
        }
