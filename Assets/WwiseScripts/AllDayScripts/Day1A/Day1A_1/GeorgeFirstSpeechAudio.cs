...
public class GeorgeFirstSpeechAudio : MonoBehaviour {
    ...
    void Update()
    {
        if (Player.IsTouching(George) && NPCSubtitlePanel.activeSelf)
        {
            if (IsPlaying == false)
            {
                IsPlaying = true;
    ...
    void GeorgeFirstAudioPlay()
    {
        switch (AudioSwitch)
        {
            ...
            case 1:
                AudioLength();
                AudioSwitch++;
                AudioToPlay("GeorgeCustom_01", 2.0f);
                break;
            case 2:
                AudioLength();
                AudioSwitch++;
            ...
            case 3:
                AudioLength();
                AudioSwitch++;
                AudioToPlay("GeorgeCustom_02", 3.0f);
                break;
            case 4:
                AudioLength();
                AudioSwitch++;
                AudioToPlay("GeorgeCustom_03", 2.0f);
                break;
            case 5:
                AudioLength();
                AudioSwitch++;
