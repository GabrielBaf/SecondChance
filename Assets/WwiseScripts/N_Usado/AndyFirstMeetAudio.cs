...
public class AndyFirstMeetAudio : MonoBehaviour {

    public ConversationTrigger AndyFirstTalk;
    ...
    void Update()
    {
        ...
        if (AndyFirstTalk == null && NPCSubtitlePanel.activeSelf)
        {
            if (IsPlaying == false)
            {
                IsPlaying = true;
    ...
    void AndyAudioPlay()
    {
        switch (AudioSwitch)
        {
            ...
            case 2:
                AudioLength();
                AudioSwitch++;
                AudioToPlay("AndyCustom_02", 1.5f);
                break;
            case 3:
                AudioLength();
                AudioSwitch++;
            ...
            case 4:
                AudioLength();
                AudioSwitch++;
                AudioToPlay("AndyCustom_02", 1.0f);
                break;
            case 5:
                AudioLength();
                AudioSwitch++;
            ...
            case 6:
                AudioLength();
                AudioSwitch++;
                AudioToPlay("AndyCustom_01", 2.0f);
                break;
            case 7:
                AudioLength();
                AudioSwitch++;
